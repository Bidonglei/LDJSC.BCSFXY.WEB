...
public interface TeachingProcessService {
     ...
     * @date 2019/5/21
     */
    Map<String, Object> listProfessorTeachingSituation(TeachingProcessREQ req);
     ...
     * @date 2019/5/22
     */
    Map<String, Object> getUndergraduateSchoolingYears();
    /**
     * @Description 学习年限:硕士生学习年限情况
     * @author linjl
     * @date 2019/5/22
     */
    Map<String, Object> getMasterSchoolingYears();
    /**
     * @Description 学习年限:博士生学习年限情况
     * @author linjl
     * @date 2019/5/22
     */
    Map<String, Object> getDoctorSchoolingYears();
    /**
    ...
    /**
     * @Description 博士延期/超期详细信息
     * @author linjl
     * @date 2019/6/19
     */
    PageInfo<DoctorMoreThanYearsRES> listDoctorMoreThanYearsDetail(DoctorMoreThanYearsREQ req);
    /**
     ...
     * @date 2019/5/23
     */
    Map<String, Object> listThesisDefenseQuality(TeachingProcessREQ req);
	 ...
	 * @date 2019/7/9
	 */
	List<Map> masterThesisExcellent(String annual,String studentType);
    /**
	 ...
	 * @date 2019/6/25
	 */
	List<Map<String, Object>> undergraduateStuEva(String semesterYear,String studentType);
	/**
	 *功能描述 本科生/研究生评教：本科生学院学生评价
	 * @author lkg
	 * @date 2019/6/25
	 */
	List<Map<String, Object>> undergraduateAcaStuEva(String semesterYear,String studentType);
	/**
	 *功能描述 研究生评教：学生评教箱线图
	 * @author lkg
	 * @date 2019/7/12
	 */
	List<Map<String, Object>> academicAndScoreBoxLine(String semesterYear);
}
