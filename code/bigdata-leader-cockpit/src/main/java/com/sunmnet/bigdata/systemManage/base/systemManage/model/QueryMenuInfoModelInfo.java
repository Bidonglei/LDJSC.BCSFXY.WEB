...
/**
 * @Description: 查询的菜单信息返回参数model的子model
 * @author zfb
 * @date 2018-04-12
 * @version 1.0
 */
public class QueryMenuInfoModelInfo   extends BaseModel {

	private static final long serialVersionUID = -6352304405581593314L;
