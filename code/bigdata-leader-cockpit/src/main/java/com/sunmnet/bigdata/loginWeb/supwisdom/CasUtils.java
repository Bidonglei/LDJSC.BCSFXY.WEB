...
public abstract class CasUtils {
    ...
    public static boolean isLogin(HttpSession session) {
        ...
        return CommonUtils.BooleanUtils.toBoolean(String.valueOf(isLogin));
    }
    ...
    public static String getTargetUrl(HttpServletRequest request) {
        ...
        if (CommonUtils.StringUtils.isEmpty(targetUrl)) {
            // 若不存在，则使用默认页面作为targetUrl
//            targetUrl = basePath + Constants.DEF_TARGET_URI;
            targetUrl = Constants.DEF_TARGET_URI;
        } else {
            // 判断target是否编码
    ...
    public static boolean hasTicket(HttpServletRequest request) {
        ...
        return ticket != null
                && !CommonUtils.StringUtils.isEmpty(String.valueOf(ticket));
    }
...
//        String serviceUrlRoot = getBasePath(request) + Constants.SSO_LOGIN_URI;
        String serviceUrlRoot = Constants.SSO_LOGIN_URI;
...
//        String loginUrlRoot = getBasePath(request) + Constants.SSO_LOGIN_URI;
        String loginUrlRoot = Constants.SSO_LOGIN_URI;
