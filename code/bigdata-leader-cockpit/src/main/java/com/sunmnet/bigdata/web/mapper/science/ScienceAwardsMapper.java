 ...
 * @date 2019/5/16
 */
public interface ScienceAwardsMapper {
    ...
    /**
     * @Description 国家奖-历史获奖-扇形图
     * @author linjl
     * @date 2019/5/17
     */
    List<Map<String, Object>> listHistoryNationalAward();
     ...
     * @date 2019/5/17
     */
    List<Map<String, Object>> listProvincialAwardInfo(ScienceAwardsREQ req);
     ...
     * @date 2019/6/27
     */
    List<Map> listChargeComplete(@Param(value="departmentName") String departmentName);
    /**
     ...
     * @date 2019/8/8
     */
    List<Map> listNurturingPlanCompletion(NurturingPlanREQ req);
    /**
     * @Description 国家奖各学院五年规划情况
     * @author linjl
     * @date 2019/8/8
     */
    List<Map> listFiveYearNurturingPlan();
    /**
     * @Description 国家奖各学院五年规划情况-图例
     * @author linjl
     * @date 2019/8/8
     */
    List<String> listFiveYearLegend();
}
