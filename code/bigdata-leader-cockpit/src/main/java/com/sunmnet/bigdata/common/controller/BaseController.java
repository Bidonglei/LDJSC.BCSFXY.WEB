package com.sunmnet.bigdata.common.controller;
...
public abstract class BaseController {
    ...
    public JsonResult handleException(BusinessException ex, HttpServletRequest req, HttpServletResponse res) {
        ex.printStackTrace();
        return buildErrJson("-1", ex.getMessage());
    }
