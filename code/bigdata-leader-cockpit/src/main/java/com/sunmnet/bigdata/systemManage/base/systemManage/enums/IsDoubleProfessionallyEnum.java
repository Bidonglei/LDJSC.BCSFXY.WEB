 ...
 * @return
 */
public enum IsDoubleProfessionallyEnum {
	...
	private IsDoubleProfessionallyEnum(String code, String msg) {
		this.code = code;
		this.msg = msg;
	}
    ...
    public static List<QueryTeacherDropDownModel>  getProfessionalTypeList(){
        ...
        IsDoubleProfessionallyEnum[] exceptionMsg = IsDoubleProfessionallyEnum.values();
       ...
       if(exceptionMsg != null && exceptionMsg.length > 0){
           ...
           for(IsDoubleProfessionallyEnum typeEnum:exceptionMsg){
