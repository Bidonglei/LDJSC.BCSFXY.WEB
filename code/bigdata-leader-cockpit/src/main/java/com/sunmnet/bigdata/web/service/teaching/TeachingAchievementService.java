 ...
 * @date 2019/5/23
 */
public interface TeachingAchievementService {
     ...
     * @date 2019/5/24
     */
    Map<String, Object> listEducationalProjectAnnual(TeachingAchievementREQ req);
     ...
     * @date 2019/5/24
     */
    Map<String, Object> listTeachingAchievementAward(TeachingAchievementREQ req);
     ...
     * @date 2019/5/24
     */
    Map<String, Object> listPostgraduateInnovationYear();
     ...
     * @date 2019/5/24
     */
    Map<String, Object> listPostgraduateInnovationAcademy();
}
