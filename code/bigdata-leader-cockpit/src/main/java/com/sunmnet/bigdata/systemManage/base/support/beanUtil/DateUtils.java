package com.sunmnet.bigdata.systemManage.base.support.beanUtil;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static final SimpleDateFormat formatTimestamp1 = new SimpleDateFormat("yyyyMMddHHmmss");
	...
	public static Timestamp getCurrentTimestamp(){
		return Timestamp.valueOf(formatTimestamp1.format(new Date()));
	}

	public static String getCurrentTimestampStr(){
		return formatTimestamp1.format(new Date());
	}
	/**
	 * 取得两个日期之间的日数
	 * 
	...
	/**
	 * 13位时间戳转换为yyyy-MM-dd格式
	 * @param date
	 * @return
	 */
	public static String longTimestampToDateStr(long date) {
		return SHORT_DATE_FORMAT.format(date);
	}
